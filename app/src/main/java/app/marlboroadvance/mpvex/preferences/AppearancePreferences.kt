...
class AppearancePreferences(
  ...
  val topRightControls =
    preferenceStore.getString(
      "top_right_controls",
      "CURRENT_CHAPTER,DECODER,AUDIO_TRACK,SUBTITLES,DANMAKU,MORE_OPTIONS",
    )
  ...
  val portraitBottomControls =
    preferenceStore.getString(
      ...
      "SCREEN_ROTATION,DECODER,AUDIO_TRACK,SUBTITLES,DANMAKU,BOOKMARKS_CHAPTERS,PLAYBACK_SPEED,BACKGROUND_PLAYBACK,REPEAT_MODE,SHUFFLE,VIDEO_ZOOM,FRAME_NAVIGATION,ASPECT_RATIO,PICTURE_IN_PICTURE,LOCK_CONTROLS,MORE_OPTIONS",
    )
